...
object ModDamageSources {
  final val TURRET: DamageSource = new DamageSource("steam_turret").setProjectile()
  final val SCALDING_TRAP: DamageSource = new DamageSource("steam_scalding_trap").setFireDamage()
}
